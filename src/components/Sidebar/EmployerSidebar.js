...
export default class EmployerSidebar extends Component {
    constructor() {
        super();
                ...
                <aside className="aside p-3">
                    ...
                    <ul className="list-group list-group-flush">
                        <li className="list-group-item py-2 border-0">
                            <a className="text-decoration-none text-dark d-block" href="/employer-dashboard">
                                <i className="bi bi-speedometer2 me-2"></i> Dashboard
                            </a>
                        </li>
                        <li className="list-group-item py-2 border-0">
                            <a className="text-decoration-none text-dark d-block" href="/created-jobs">
                                <i className="bi bi-briefcase me-2"></i> Created Jobs
                            </a>
                        </li>
                        <li className="list-group-item py-2 border-0">
                            <a className="text-decoration-none text-dark d-block" href="/applied-applications">
