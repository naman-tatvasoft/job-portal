...
export default class RegisterEmployer extends Component {
  ...
  render() {
    ...
    return (
      <div id="register-employer" className="auth-section container-fluid">
                  ...
                  <div className="col-lg-8 col-md-10">
                    <div className="auth-card">
                      <div className="auth-header">
                        ...
                        <p>Sign up as an  elsemployer</p>
                      </div>
                      <div className="auth-body">
                        <form id="signUpCandidateForm" onSubmit={this.handleSubmit}>
                        <h2>Register Employer</h2>
                          <div className="form-floating m-1">
                            <input type="name" className="form-control p-2" id="SignUpName" placeholder="Name" name="name" value={name} onInput={this.handleInput} />
                            <label for="SignUpName"><i className="fas fa-envelope me-2"></i>Name</label>
                          </div>
                          <div className="form-floating m-1">
                            <input type="name" className="form-control" id="SignUpCompanyName" placeholder="Company Name" name="CompanyName" value={companyName} onInput={this.handleInput} />
                            <label for="SignUpCompanyName"><i className="fas fa-envelope me-2"></i>Company Name</label>
                          </div>
                          <div className="form-floating m-1">
